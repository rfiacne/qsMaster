...
class TestAuditRecord:
    ...
    def test_with_values(self):
        r = AuditRecord(
            ...
            from_standard_answer=True, match_type="exact",
        )
    ...
    def test_from_dict_roundtrip(self):
        original = AuditRecord(  # noqa: F841 — used implicitly in assert
            question="Q", answer="A", total_time_ms=100.0,
            faithfulness_result="pass", faithfulness_score=0.9,
        )
        d = {"timestamp": "", "session_id": "", "question": "Q", "answer": "A",
             "retrieval_time_ms": 0.0, "generation_time_ms": 0.0, "total_time_ms": 100.0,
             "from_standard_answer": False, "match_type": "", "faithfulness_result": "pass",
             "faithfulness_score": 0.9, "sources": [], "api_error": None}
...
class TestAuditStore:
    ...
    def test_query_by_time_range(self):
        self.store.append(AuditRecord(
            question="旧问题", timestamp="2024-01-01T00:00:00"
        ))
        self.store.append(AuditRecord(
            question="新问题", timestamp="2024-06-01T00:00:00"
        ))
    ...
    def test_get_stats_with_data(self):
        ...
        self.store.append(AuditRecord(
            question="Q2", answer="A2", total_time_ms=200.0,
